  ...
  return (
    <>
      <header className="tauri-android-safe-top sticky top-0 z-10 w-full border-b bg-background/80 backdrop-blur-sm">
        <div className="mx-auto flex min-h-[6.25rem] w-full max-w-[1540px] flex-col items-stretch gap-1.5 px-3 pb-3 pt-2 sm:h-16 sm:min-h-16 sm:flex-row sm:items-center sm:justify-between sm:gap-4 sm:px-6 sm:py-3 lg:px-8 2xl:px-10">
          <div className="order-2 flex min-h-11 min-w-0 flex-1 flex-nowrap items-center gap-2 pb-1.5 sm:order-1 sm:min-h-0 sm:gap-4 sm:pb-0">
            {children}
          </div>
